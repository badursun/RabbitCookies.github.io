    ...
    $.RabbitCookies = function (options) {
        ...
        const applyCSS = () => {
            $('<style>').text(`
                ...
                html.rabbit-cookie-popup{overflow:hidden}.rabbitcookie-overlay{position:fixed;top:0;left:0;width:100%;height:100%;background-color:rgba(0,0,0,.7);z-index:99998;transition:opacity .6s ease-in-out;opacity:1}.rabbitcookie-overlay.overlay-hidden{opacity:0;width:0;height:0}.rabbit-cookie-banner{font-family:sans-serif;position:fixed;background-color:#fff;color:#000;z-index:99999;border-radius:8px;max-width:440px;transition:.2s ease-in-out;box-shadow:0 4px 8px rgba(0,0,0,.3)}.rabbit-cookie-banner[data-position=bottom-right]{bottom:70px;right:20px}.rabbit-cookie-banner[data-position=bottom-left]{bottom:70px;left:20px}.rabbit-cookie-banner[data-position=top-right]{top:20px;right:20px}.rabbit-cookie-banner[data-position=top-left]{top:20px;left:20px}.rabbit-cookie-banner[data-position=center-modal]{top:50%;left:50%;transform:translate(-50%,-50%);max-width:500px;min-height:250px;display:flex;flex-direction:column;justify-content:space-between}.rabbit-cookie-banner[data-position=bottom-line]{bottom:0;left:0;max-width:none;width:100vw;border-radius:0}.rabbit-cookie-banner[data-position=top-line]{top:0;left:0;max-width:none;width:100vw;border-radius:0}.rabbit-cookie-banner[data-position=bottom-left].hidden,.rabbit-cookie-banner[data-position=bottom-line].hidden,.rabbit-cookie-banner[data-position=bottom-right].hidden,.rabbit-cookie-banner[data-position=center-modal].hidden{bottom:-200%}.rabbit-cookie-banner[data-position=top-left].hidden,.rabbit-cookie-banner[data-position=top-line].hidden,.rabbit-cookie-banner[data-position=top-right].hidden{top:-200%}.rabbit-cookie-banner .rabbitcookie-close{padding:5px;position:absolute;right:0;display:block;width:30px;text-align:center;font-weight:600;font-size:20px;color:red;z-index:999;text-decoration:none;cursor:pointer}.rabbit-cookie-banner .rabbitcookie-close:hover{text-decoration:none}.rabbit-cookie-banner .rabbit-cookie-icon{display:flex}.rabbit-cookie-banner .rabbit-cookie-icon i,.rabbit-cookie-banner .rabbit-cookie-icon svg{width:60px;height:60px}.rabbit-cookie-banner .rabbit-cookie-text{padding:10px}.rabbit-cookie-banner .rabbit-cookie-text h4{padding:0;margin:0;font-size:20px;color:var(--rc-banner-txt)}.rabbit-cookie-banner .rabbit-cookie-text p{padding:0;margin:5px 0;font-size:13px;color:var(--rc-banner-txt)}.rabbit-cookie-banner .rabbit-cookie-actions{padding:20px 0}.rabbit-cookie-banner .rabbit-cookie-actions .rabbit-btn{padding:6px 10px;border-radius:4px;border:none;cursor:pointer;transition:background-color .3s;font-size:12px}.rabbit-cookie-banner .rabbit-cookie-actions #rabbitcookie-accept.rabbit-btn:hover{background-color:#8bc34a}.rabbit-cookie-banner .rabbit-cookie-actions #rabbitcookie-decline.rabbit-btn:hover{background-color:#d00000}.rabbit-cookie-banner .rabbit-cookie-actions #rabbitcookie-details.rabbit-btn:hover{background-color:#9e9e9e}.rabbitcookie-buttons{display:flex;flex-direction:row;justify-content:end;margin-top:30px}.rabbitcookie-buttons.cookies-allowed #rabbitcookie-accept::before{content:"\\2713";margin-right:5px;color:green}.rabbitcookie-brand{display:flex;flex-direction:row;padding:4px 0;font-size:10px;justify-content:end;opacity:.4;margin:0}.rabbit-cookie-banner:hover .rabbit-cookie-dev,.rabbitcookie-brand:hover{opacity:1}.rabbitcookie-btn{margin:0 5px;padding:6px 15px;border:none;background-color:var(--rc-button-bg);color:var(--rc-button-txt);cursor:pointer;font-size:12px;border-radius:5px;font-weight:600}.rabbit-cookie-banner[data-mode=dark] .rabbit-cookie-icon i,.rabbit-cookie-banner[data-mode=dark] .rabbit-cookie-icon svg,.rabbit-cookie-banner[data-mode=dark] .rabbit-cookie-text,.rabbitcookie-btn:hover{filter:invert(1)}.rabbitcookie-btn[disabled]{opacity:.6;pointer-events:none}.rabbitcookie-btn[disabled]:hover{filter:unset}.rabbitcookie-floating-btn{position:fixed;bottom:20px;right:20px;z-index:1001;background-color:var(--rc-badge-bg);border-radius:200px}.rabbitcookie-floating-icon{font-size:24px;line-height:34px;background:0 0;border:none;cursor:pointer;outline:0;box-shadow:rgba(0,0,0,.1) 0 4px 12px;border-radius:500px}.rabbitcookie-floating-icon.cookie-accepted{border:2px solid #00800045}.rabbitcookie-floating-icon.cookie-declined{border:2px solid #ff000045}.rabbitcookie-consent-iframe-overlay{position:absolute;top:0;left:0;width:100%;height:100%;background-color:rgba(0,0,0,.8);z-index:99997;display:flex;align-items:center;justify-content:center;color:#fff;box-shadow:rgba(0,0,0,.45) 0 25px 20px -20px}.rabbit-popover{visibility:hidden;background-color:#000;color:#fff;text-align:center;padding:0 10px;border-radius:4px;position:absolute;left:-90px;top:50%;transform:translateY(-50%);font-size:11px}.rabbit-popover::before{content:"";position:absolute;top:50%;right:-8px;margin-top:-5px;border-width:5px;border-style:solid;border-color:transparent transparent transparent #000}.rabbitcookie-floating-icon:hover .rabbit-popover{visibility:visible}.iframe-overlay-text{text-align:center;font-size:14px;font-weight:400;position:relative;width:100%;height:100%;display:block;align-content:center}.iframe-overlay-text a{color:#fff;text-decoration:underline}.iframe-overlay-text svg{width:45px;height:45px;margin-bottom:20px}.iframe-overlay-text small{display:inline-block;background-color:#ff000057;border-radius:4px;font-size:10px;padding:2px 10px;margin-top:10px;opacity:.6}.rabbit-cookie-banner .rabbit-cookie-dev{padding:5px 30px!important;display:flex;font-size:10px;justify-content:end;color:#000;opacity:.4}.rabbit-cookie-banner[data-mode=dark] .rabbit-cookie-dev{color:#fff}.rabbit-cookie-banner[data-mode=dark]{background-color:#1a1a2e;color:#f1f1f1}.rabbit-cookie-banner[data-theme=theme-1] .rabbit-cookie-icon{min-height:90px;padding:10px;justify-content:center;align-items:center}.rabbit-cookie-banner[data-theme=theme-1] .rabbit-cookie-icon i,.rabbit-cookie-banner[data-theme=theme-2] .rabbit-cookie-icon i{font-size:46px}.rabbit-cookie-banner[data-theme=theme-1] .rabbit-cookie-text{padding:20px 30px;text-align:center}.rabbit-cookie-banner[data-theme=theme-1] .rabbit-cookie-actions{display:flex;justify-content:center;gap:15px}.rabbit-cookie-banner[data-theme=theme-2] .rabbit-cookie-icon{display:none}.rabbit-cookie-banner[data-theme=theme-2] .rabbit-cookie-text{padding:20px 30px;text-align:left}.rabbit-cookie-banner[data-theme=theme-2] .rabbit-cookie-actions{padding:10px 30px;display:flex;flex-direction:row;justify-content:flex-end;gap:10px}.rabbit-cookie-banner[data-theme=theme-2] .rabbit-btn,.rabbit-cookie-banner[data-theme=theme-3] .rabbit-btn{margin:0}.rabbit-cookie-banner[data-theme=theme-3]{display:flex;flex-wrap:wrap;gap:5px;max-width:600px;padding:10px}.rabbit-cookie-banner[data-theme=theme-3] .rabbit-cookie-icon{flex:none;width:60px;justify-content:center;align-items:center}.rabbit-cookie-banner[data-theme=theme-3] .rabbit-cookie-icon i{font-size:20px}.rabbit-cookie-banner[data-theme=theme-3] .rabbit-cookie-text{text-align:left;flex:auto}.rabbit-cookie-banner[data-theme=theme-3] .rabbit-cookie-actions{display:flex;justify-content:end;gap:10px;padding:0}.rabbit-cookie-banner[data-theme=theme-3]>div{flex:1 1 calc(25% - 10px);box-sizing:border-box;padding:10px;text-align:center}.rabbit-cookie-banner[data-theme=theme-3]>div:last-child{flex:1 1 100%}@media (max-width:768px){.rabbitcookie-banner{font-size:12px;max-width:calc(100% - 15px)!important;right:15px!important;left:15px!important}.rabbitcookie-btn{font-size:12px;padding:8px 16px}}
            `).appendTo('head');
        };
